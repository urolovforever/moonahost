...
function About() {
  return (
    <div className="min-h-screen bg-surface-light py-16">
      <SEOHelmet
        title="Biz haqimizda"
        description="MoonGift - zamonaviy lazer texnologiyasidan foydalanib, yog'och va boshqa materiallarga yuqori aniqlikdagi ishlov berish xizmatlarini taqdim etuvchi kompaniya. Biz har bir buyurtmani maxsus e'tibor bilan bajaramiz."
        keywords="MoonGift haqida, lazer texnologiyasi, yuqori sifat, yog'och ishlov berish, kompaniya tarixi, bizning xizmatlar"
        url="/about"
      />
